...
####################################################################
corpus.pro2tdm <- function(corpus.pro, ponderacion, n_terms){
  #matriz TD 
  ...
  #matriz transpiesta de los n_terms mas frecuentes
...
matriz <- corpus.pro2tdm(corpus.pro, "weightTf", 150)
dim(matriz)
...
cbind(df_lyrics_seleccionado[-c(3)], df_tm)
