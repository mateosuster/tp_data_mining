...
en_lyrics <- en_lyrics %>% select (-c("lyrics", "lyrics_cleaning","sin_stopwords", "cant_bad_words"))
...
df_ly_feat_esp <- df_ly_feat_esp %>% select (-c("lyrics", "lyrics_cleaning","sin_stopwords"
