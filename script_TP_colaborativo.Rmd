...
iforest_sample = isolation.forest(as.matrix(df_audio_charts_s_at_redund[,2:(ncol(df_audio_charts_s_at_redund))-2]),
                                  sample_size = 800, ntrees=100, ndim = 2, random_seed = 1)

#utilzo el metodo predict para calcula el score sobre todos los puntos
df_audio_charts_s_at_redund$iforest_pred = predict(iforest_sample,
                                                   df_audio_charts_s_at_redund[,2:(ncol(df_audio_charts_s_at_redund))-2])

#que paises identifico?
top_ifores_sample <- head(df_audio_charts_s_at_redund[order(df_audio_charts_s_at_redund$iforest_pred, decreasing = T),],
                          200)
