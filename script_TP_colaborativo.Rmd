...
cor(df_audio_charts_s_at_redund[,2:ncol(df_audio_charts_s_at_redund)], use = "complete.obs") 
```
...
df_audio_charts_s_at_redund.PCA = prcomp(df_audio_charts_s_at_redund[,2:(ncol(df_audio_charts_s_at_redund))], 
                                         scale. = TRUE)
...
CP1 = as.matrix(scale(df_audio_charts_s_at_redund[,2:6])) %*% as.matrix(carga1[,"carga_1"])
CP2 = as.matrix(scale(df_audio_charts_s_at_redund[,2:6]))%*% as.matrix(carga2[,"carga_2"])
...
#ajusto el modelo
df_audio_charts_s_at_redund_scale <-  data.frame(df_audio_charts_s_at_redund[,1],
                                            scale(df_audio_charts_s_at_redund[,2:6]))

iforest_sample = isolation.forest(as.matrix(df_audio_charts_s_at_redund_scale[,2:6]),
...
freq_outlier <- as.data.frame(table(join_audio_charts[join_audio_charts$track_name%in%
                                                        top_ifores_sample$track_name,"track_name"]))
