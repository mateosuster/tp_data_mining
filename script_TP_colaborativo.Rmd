...
# BIPLOT
ggbiplot(df_audio_charts_s_at_redund.PCA, obs.scale=0.75 ,var.scale=0.75,alpha=0.05)
...
iforest_sample = isolation.forest(as.matrix(df_audio_charts_s_at_redund_scale[,2:ncol(df_audio_charts_s_at_redund)]),
