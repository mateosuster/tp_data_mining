...
df_ly_feat <- df_ly_feat %>% select (-c("artist_key","track_name","lyrics", "lyrics_cleaning","sin_stopwords", "cant_bad_words"))
...
df_ly_feat_esp <- df_ly_feat_esp %>% select (-c("artist_key","track_name","lyrics",  "lyrics_cleaning","sin_stopwords")
...
df_melt_esp <- reshape2::melt(data = df_ly_feat_ok_esp[,2:ncol(df_ly_feat_ok_esp)], id.vars = c("id"))  %>%
  arrange(id)
