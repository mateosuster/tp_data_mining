...
for (i in nrow(df_audio_features)){
df_audio_features$cant_markets <- length(unlist(strsplit(df_audio_features[i,"markets_concat"], split = ",")))
}


sapply(df_audio_features[,"artists"], concat_column)
