...
barplot(sort(tabla_isinchart, decreasing = TRUE), names.arg="", xlab='En Charts',col=rgb(0.2,0.4,0.6,0.6), )
barplot(sort(tabla_notinchart, decreasing = TRUE), names.arg = "", xlab='Fuera de Charts',col=rgb(0.2,0.4,0.6,0.6))
```

```{r}
in_chart <- as.data.frame(tabla_isinchart)
```
...
`instrumentalness` tiene mucho sesgo la variable. Quizás sirva discretizar la variable.  

```{r}
hist(1/sqrt(df_audio_features$instrumentalness), main="Instrumentalness", xlab = '')
```
